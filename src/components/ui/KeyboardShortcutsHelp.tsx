        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dev-surface rounded-xl shadow-2xl z-101 min-w-100 max-w-[90vw] max-h-[80vh] overflow-hidden"
            >
                ...
                <div className="flex flex-col gap-3">
                  {KEYBOARD_SHORTCUTS.map((shortcut, index) => (
                    <div key={index} className="flex items-center gap-4">
                      <kbd className="inline-flex items-center justify-center min-w-25 px-3 py-1.5 bg-dev-bg border border-dev-border rounded-md font-mono text-xs font-semibold text-dev-text whitespace-nowrap">
